...
- Boot demo deployed as `main.py` with a Codex-style animated logo

## Layout
- `QUICK/firmware/`: firmware binary
- `QUICK/code/`: first MicroPython scripts (`display_smoke.py`, `logo_anim.py`, `main.py`)
...
uvx --from mpremote mpremote connect "$PORT" fs cp QUICK/code/logo_anim.py :logo_anim.py + fs cp QUICK/code/main.py :main.py + fs cp QUICK/code/display_smoke.py :display_smoke.py
...
- On reset/boot (`main.py`): continuous Codex-style knot animation with a pulsing center and moving status rail
